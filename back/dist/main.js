...
var routes = [
    { path: 'login', component: _component_login_login_component__WEBPACK_IMPORTED_MODULE_2__["LoginComponent"], data: { animation: 'login' }, canActivate: [_guards_login_guard__WEBPACK_IMPORTED_MODULE_6__["LoginGuard"]] },
    { path: '', redirectTo: 'login', pathMatch: 'full', data: { animation: 'login' }, canActivate: [_guards_login_guard__WEBPACK_IMPORTED_MODULE_6__["LoginGuard"]] },
    { path: 'register', component: _component_register_register_component__WEBPACK_IMPORTED_MODULE_3__["RegisterComponent"], data: { animation: 'register' }, canActivate: [_guards_login_guard__WEBPACK_IMPORTED_MODULE_6__["LoginGuard"]] },
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.onLogin = function () {
        ...
        if (this.user === undefined || this.password === undefined) {
            this._snackBar.open('plz check login form', 'Undo', { duration: 3333 });
            return false;
        }
        var log = {
            user: this.user,
...
module.exports = "nav .notifications .notification img, nav .messages .notification img, nav .friends-requst .notification img {\n  width: 30px;\n  height: 30px;\n  border-radius: 50%; }\n\nnav .notifications .notification a, nav .messages .notification a, nav .friends-requst .notification a {\n  color: #000; }\n\nnav .right-side a {\n  color: #fff;\n  font-size: 16px; }\n\nnav .right-side a img {\n    width: 40px;\n    height: 40px;\n    border-radius: 50%;\n    box-shadow: 0 0 5px #000; }\n\n.d-sm-none, .d-lg-none {\n  display: none; }\n\nnav {\n  padding: 20px;\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  z-index: +5000000;\n  background-color: #000;\n  color: #fff;\n  overflow: hidden !important; }\n\nnav .right-side {\n    width: 30%;\n    float: left; }\n\nnav .right-side .username {\n      display: inline-block; }\n\nnav .ul {\n    width: 70%;\n    height: 100%;\n    float: left;\n    list-style: none;\n    text-align: right; }\n\nnav .ul span {\n      display: inline-block;\n      margin: 5px;\n      cursor: pointer;\n      line-height: 40px; }\n\nnav .ul a {\n      color: #fff !important; }\n\nnav .ul .d-lg {\n      float: left;\n      display: none; }\n\n@media (min-width: 992px) {\n      nav .ul .d-lg {\n        display: block; } }\n\nnav .notifications, nav .messages, nav .friends-requst {\n    overflow: auto;\n    background: #fff;\n    color: #000;\n    position: fixed;\n    z-index: +1000;\n    top: 86px;\n    bottom: 0;\n    padding: 5px 20px;\n    background-color: rgba(0, 0, 0, 0.5);\n    right: 0px;\n    -webkit-transform: translateX(-50%);\n            transform: translateX(-50%); }\n\nnav .notifications mat-icon, nav .messages mat-icon, nav .friends-requst mat-icon {\n      float: right;\n      cursor: pointer;\n      color: red; }\n\nnav .notifications .notification, nav .messages .notification, nav .friends-requst .notification {\n      padding: 25px 10px; }\n\nnav .notifications .notification p, nav .messages .notification p, nav .friends-requst .notification p {\n        text-align: left;\n        color: #fff;\n        padding: 5px 10px; }\n\nnav .notifications .notification .users, nav .messages .notification .users, nav .friends-requst .notification .users {\n        margin-top: 10px;\n        background-color: rgba(0, 0, 0, 0.2); }\n\nnav .notifications .notification .users .post-user, nav .messages .notification .users .post-user, nav .friends-requst .notification .users .post-user {\n          padding-top: 15px;\n          font-size: 12px; }\n\nnav .notifications .notification .users a, nav .messages .notification .users a, nav .friends-requst .notification .users a {\n          color: #fff; }\n\nnav .notifications .zero-request, nav .messages .zero-request, nav .friends-requst .zero-request {\n      position: absolute;\n      top: 50%;\n      left: 50%;\n      transform: translateX(-50%) translateY(-50%);\n      -webkit-transform: translateX(-50%) translateY(-50%);\n      -moz-transform: translateX(-50%) translateY(-50%);\n      -o-transform: translateX(-50%) translateY(-50%);\n      padding: 10px; }\n\n@media (max-width: 992px) {\n  .notifications, .messages, .friends-requst {\n    right: 26px !important; }\n    .notifications::before, .messages::before, .friends-requst::before {\n      display: none; }\n  .right-side {\n    width: 40%; }\n  .ul {\n    width: 60%; } }\n\n@media (max-width: 778px) {\n  nav {\n    padding: 10px; }\n    nav .right-side {\n      width: 30%; }\n      nav .right-side .username {\n        display: none; }\n    nav .ul {\n      width: 70%; }\n      nav .ul mat-icon {\n        font-size: 18px;\n        width: 18px;\n        height: 18px; }\n    nav .d-sm-none {\n      display: block; }\n    nav .notifications, nav .messages, nav .friends-requst {\n      display: none; } }\n\n@media (min-width: 778px) {\n  .d-lg-none {\n    display: block; }\n  .username {\n    display: none; } }\n\n.is-read {\n  background-color: #fff !important; }\n\n.is-read p {\n    color: #000 !important; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var socket = socket_io_client__WEBPACK_IMPORTED_MODULE_1___default()('http://192.168.20.102:3000');
var SocketService = /** @class */ (function () {
    function SocketService(_services) {
        this._services = _services;
    }
    ...
    SocketService.prototype.onNotificationsAndfriedsReqLength = function (data) {
